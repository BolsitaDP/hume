...
const ES_COPY: Record<HabitCategory, CategoryCopy> = {
  study: {
    focus: 'estudio',
    action: 'siéntate y estudia ahora',
    loss: 'te quedas atrás mientras otros avanzan',
    win: 'tu nivel sube y se nota',
    identity: 'tu versión preparada',
  },
  exercise: {
    focus: 'entrenamiento',
    action: 'entrena hoy sin negociar',
    loss: 'tu cuerpo paga cada aplazo',
    win: 'tu cuerpo responde más fuerte',
    identity: 'tu versión fuerte',
  },
  health: {
    focus: 'salud',
    action: 'cumple tu hábito de salud hoy',
    loss: 'tu energía se cae por tus propias decisiones',
    win: 'tu energía y enfoque mejoran',
    identity: 'tu versión cuidada',
  },
  work: {
    focus: 'trabajo',
...
const ES_TEMPLATES: StyleTemplateSet = {
  positive: {
    0: {
      lead: [
        (c) => `Hoy toca ${c.focus}.`,
        (c) => `Tu día mejora cuando cumples ${c.focus}.`,
        (c) => `Un paso real en ${c.focus} vale más que mil ideas.`,
        (c) => `El progreso empieza contigo hoy.`,
        (c) => `${c.identity} aparece cuando actúas.`,
      ],
      thrust: [
        (c) => `${c.action}.`,
        (c) => `Hazlo y ${c.win}.`,
        (c) => `Cumple esto y cambias el ritmo del día.`,
        (c) => `Pequeño acto, gran impacto: ${c.action}.`,
    ...
    1: {
      lead: [
        ...
        (c) => `No es cuestión de ganas, es cuestión de palabra.`,
        (c) => `Tu discurso se valida con ejecución.`,
      ...
      thrust: [
        ...
        (c) => `Acción corta ahora, confianza grande después.`,
        (c) => `Tu identidad mejora cuando actúas.`,
      ],
      finish: [
    ...
    2: {
      lead: [
        (c) => `Tu estándar en ${c.focus} se decide hoy.`,
        (c) => `Cada excusa que cortas te vuelve más fuerte.`,
        (c) => `No esperes motivación: fabrica resultados.`,
    ...
    3: {
      lead: [
        ...
        (c) => `Tu versión elite no pide permiso.`,
        (c) => `Este minuto decide tu narrativa.`,
      ],
      thrust: [
        (c) => `${c.action}.`,
        (c) => `Hazlo y ${c.win}.`,
        (c) => `Ejecución brutal en ${c.focus}.`,
        (c) => `Hoy te conviertes en alguien más serio.`,
        (c) => `Tu identidad se forja en acción inmediata.`,
      ],
      finish: [
        () => `Ahora.`,
        () => `Sin pausa.`,
  ...
  negative: {
    0: {
      lead: [
        ...
        (c) => `Si lo dejas para después, pagas después.`,
        (c) => `Hoy se evita otro arrepentimiento inútil.`,
      ...
      thrust: [
        ...
        (c) => `Una acción hoy te evita culpa hoy.`,
    ...
    1: {
      lead: [
        ...
        (c) => `Ya sabes lo que toca y aun así aplazas.`,
      ...
      thrust: [
        ...
        (c) => `No necesitas otra charla, necesitas ejecución.`,
        (c) => `Cada minuto aplazado te hace ver pequeño.`,
      ],
      finish: [
        () => `Muévete.`,
        () => `Ya.`,
    ...
    2: {
      lead: [
        ...
        (c) => `La comodidad te está ganando otra vez.`,
      ],
      thrust: [
        (c) => `${c.action}.`,
        (c) => `Si no lo haces, ${c.loss}.`,
        (c) => `Hoy o confirmas fuerza o confirmas debilidad.`,
        (c) => `Tu orgullo debería picarte leyendo esto.`,
        (c) => `Deja la pose y produce acción real.`,
      ],
      finish: [
        () => `Corrígelo ahora.`,
        () => `Sin negociar.`,
    ...
    3: {
      lead: [
        (c) => `Mucho ego, poca ejecución en ${c.focus}.`,
        (c) => `Te duele leer esto porque es verdad.`,
        (c) => `Hablas como ganador, actúas como espectador.`,
        (c) => `Tu problema no es tiempo: es cobardía para actuar.`,
        (c) => `Te está ganando una tarea mínima otra vez.`,
      ],
      thrust: [
        (c) => `${c.action}.`,
        (c) => `Si hoy te escondes, ${c.loss}.`,
        (c) => `Tu orgullo debería arder con esta realidad.`,
